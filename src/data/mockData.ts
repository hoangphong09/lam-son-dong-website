...
export const HERO_SLIDES: HeroSlide[] = [
  ...
  },
  {
    id: 'slide-2',
    tag: '',
    title: 'Bảo Vệ Trọng Điểm & Đối Tác Chiến Lược Với Thành Phố Hà Nội',
  ...
  },
  {
    id: 'slide-3',
    tag: '',
    title: 'Trung Tâm Điều Hành Tập Trung & Tuần Tra Trí Tuệ Nhân Tạo',
    description: 'Kiểm soát lộ trình tuần tra GPS thời gian thực, phát hiện xâm nhập và nguy cơ hỏa hoạn trong 3 giây, tự động điều động phản ứng nhanh cơ động.',
